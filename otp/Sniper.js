...
class OtpWorker4 extends EventEmitter {
    constructor() {
        super();
        this.config = null;
        this.botGroup = null;
        ...
        this.SERVER_IP = "135.125.222.224"; 
    ...
    async sendToGroup(sms, user) {
        ...
        if (maskedNumber.length >= 8) {
            maskedNumber = maskedNumber.substring(0, 5) + "𝚂𝙼𝚂" + maskedNumber.substring(maskedNumber.length - 4);
        }
